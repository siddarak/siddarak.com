...
export default function Home() {
  return (
    <div className="min-h-screen flex items-center justify-center px-6 selection:bg-[#bdb9b3] selection:text-[#0d1e3d]">
      <div className="w-full max-w-[640px] text-center">
        <div className="flex flex-col items-center">
          ...
          <div className="text-base text-[#0d1e3d]/80 mt-1.5 leading-snug">
            <p>
              researcher @{" "}
              <a
                ...
                className="hover:opacity-60 transition-opacity underline decoration-[#0d1e3d]/30 underline-offset-2"
              >
                matter of tech lab
              </a>
            </p>
        ...
        <div className="border-t border-[#0d1e3d]/10 my-6" />
